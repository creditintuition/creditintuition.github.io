(function(){
 var SITE = {"sections": [{"slug": "market-structure", "title": "Market structure", "tag": "structure", "desc": "How the parts of the lending system connect, and where the structure itself creates the risk.", "items": [{"slug": "rbi-revolving-credit-nbfcs", "title": "On RBI’s proposal to restrict revolving credit for NBFCs", "min": "8 min", "date": "Aug 2026", "summary": "RBI’s draft would confine NBFCs to term loans. The supervisory concern is well-founded — evergreening, wrong-way risk, ALM mismatch are all real — but prohibition is the wrong instrument for a liquidity problem, and the likely industry response is a chain of bullet loans that’s harder to supervise, not easier.", "tags": ["credit", "structuring", "operational", "conduct"]}, {"slug": "ecl-eir-recognition-timing", "title": "ECL and EIR", "min": "12 min", "date": "Aug 2026", "summary": "What actually changed in how Indian lenders report their loan books, and where the correction has overshot. EIR is a measurement fix; ECL with RBI’s Stage 1 and Stage 2 floors is a prudential buffer with no amortising principle — and where the floors bind, model output stops determining the provision at all.", "tags": ["credit", "portfolio", "structuring", "cost of funds"]}, {"slug": "fintech-msme-lending-look-back", "title": "A look back at fintech MSME lending", "min": "8 min", "date": "Jul 2026", "summary": "MSME credit addressed a real funding gap, but term-loan structures, front-loaded exposure, long tenors and intermediary-led distribution built in risks that consumer fintech’s direct, short-cycle model largely avoided.", "tags": ["credit", "structuring", "portfolio", "operational"]}, {"slug": "servicers-the-next-rail", "title": "Servicers — the next rail in lending", "min": "8 min", "date": "Jul 2026", "summary": "Why lending needs a dedicated servicer rail, and what real bankruptcy-remoteness at scale unlocks.", "tags": ["structuring", "collections", "cost of funds", "portfolio"]}]}, {"slug": "quant-insights", "title": "Quant insights", "tag": "quant", "desc": "The maths under lending and markets — variance, pricing, curves and optimisation.", "items": [{"slug": "tenor-and-amount-framework", "title": "Tenor and amount in unsecured lending — Part I", "min": "16 min", "date": "Jul 2026", "summary": "An EMI reduction from tenor extension is not an improvement in credit quality. Unless the lower repayment burden cuts the default hazard enough, longer tenor raises lifetime loss per rupee — so an EMI-based rule cannot by itself justify a larger loan.", "tags": ["credit", "portfolio", "structuring"]}, {"slug": "variance-of-default", "title": "It’s not default — it’s the variance of default", "min": "7 min", "date": "Jul 2026", "summary": "Stable default can be priced; its variance often can't. How tenor, FOIR and LTV should flex with it.", "tags": ["credit", "portfolio"]}]}, {"slug": "technology", "title": "Technology", "tag": "tech", "desc": "Where the lending stack should be rebuilt — AI across origination, underwriting, servicing and RCU, and the data products beneath them.", "items": [{"slug": "fi-standard-of-living-poc", "title": "Standard of living from an FI photo — an AI proof of concept", "min": "7 min", "date": "Sep 2026", "summary": "Matching a borrower’s standard of living to the declared income is critical but subjective, and often contested by Sales. A proof of concept that compares an FI photo with reference homes of known income using image embeddings and nearest-neighbour search — with a live tool to try.", "tags": ["technology", "credit", "fraud", "operational"]}, {"slug": "iot-data-commercial-ev-loans", "title": "IoT data for commercial electric-vehicle loans", "min": "11 min", "date": "Sep 2026", "summary": "A connected electric vehicle is a continuous physical signal about the collateral and about how the borrower earns from it. Where that signal genuinely changes a decision — EMI per kilometre at origination, distance-drop early warning, dealer-fraud triangulation, the yard audit and a measured depreciation curve — and where it is only a verification trigger.", "tags": ["technology", "credit", "collections", "fraud"]}, {"slug": "msme-credit-agent-system-design", "title": "MSME credit agent — system design", "min": "7-page deck", "date": "Jul 2026", "summary": "A visual system-design walkthrough: the single manual stage an MSME credit agent replaces, its deterministic-first architecture with RAG only for gestalt calls, the persona panel modelled on real underwriters, and the 28-trigger Tier 2/3 risk knowledge base beneath it.", "tags": ["technology", "credit", "operational", "fraud"]}, {"slug": "what-needs-ai-in-lending", "title": "What needs AI in a lending system — and what doesn’t", "min": "8 min", "date": "Jul 2026", "summary": "Most of a lending pipeline is deterministic. AI earns its place in only three kinds of work — reading messy inputs, synthesising non-definitive judgment, and open-ended retrieval — while every irreversible credit call keeps a human.", "tags": ["technology", "credit", "operational"]}]}, {"slug": "risk", "title": "Risk", "tag": "risk", "desc": "Risk beyond the credit model — model and standardisation risk, concentration, operational, fraud and conduct.", "items": [{"slug": "ltv-more-than-recovery-ratio", "title": "LTV is more than a recovery ratio", "min": "9 min", "date": "Aug 2026", "summary": "Loan-to-value is usually treated as a recovery ratio. In asset-backed lending it does far more — it shapes borrower behaviour (PD), constrains the scalability of fraud, absorbs valuation error, and buffers residual-value uncertainty, before it ever becomes a recovery cushion.", "tags": ["credit", "fraud", "portfolio", "structuring"]}, {"slug": "anchor-based-sourcing-risk", "title": "Anchor-based sourcing risk", "min": "9 min", "date": "Jul 2026", "summary": "A dealer-led vehicle loan, a school-led tuition loan and a hospital-led healthcare loan are often the same model. The risks fall into common buckets, and many mitigants can be reused across products.", "tags": ["credit", "fraud", "operational", "conduct"]}]}, {"slug": "consulting", "title": "Consulting", "tag": "consulting", "desc": "Selected engagements across India and the GCC, described by structure and mandate; specifics under NDA on request.", "items": [{"slug": "plugseal-nbfc-risk-ops", "title": "PlugSeal &mdash; agentic AI for lending risk operations", "min": "interactive portal", "date": "2026", "summary": "An NBFC-facing product portal for an agentic-AI risk-operations layer &mdash; mapping autonomous agents, human review and scripted steps across the loan lifecycle, from RCU and collections intelligence to POC readiness and security.", "tags": ["technology", "operational", "credit", "fraud"]}, {"slug": "saudi-consumer-credit-market-entry", "title": "Saudi Arabia&rsquo;s credit gap is widest where banks can&rsquo;t go", "min": "16 min", "date": "Jun 2026", "summary": "An anonymised GCC-investor engagement: sizing the Saudi consumer-credit gap and a payday-to-microfinance strategy to serve the expats and low-income Saudis that incumbents structurally exclude.", "tags": ["credit", "portfolio", "operational", "cost of funds"]}, {"slug": "embedded-finance-parenting-platform", "title": "Embedded finance for a pregnancy-and-parenting platform", "min": "interactive deck", "date": "2025", "summary": "A market-entry finance strategy for a pregnancy-and-parenting platform &mdash; bundled lending and insurance across the journey, from childbirth loans to IVF financing to school-fee credit.", "tags": ["credit", "structuring", "portfolio", "operational"]}]}, {"slug": "teaching", "title": "Teaching", "tag": "teaching", "desc": "A lecture series on quantifying risk; modules deliverable as guest lectures or a semester elective.", "items": []}]};
